...
export class StaffService {
    ...
    urlStaff = {
        ...
        delete: "http://localhost:3000/api/staff/update/",
        post: "http://localhost:3000/api/staff/update/"
    }
    ...
    updateStaff(id: ObjectId, staff: StaffModel) {
        return new Promise (
            (resolve, reject) => {
